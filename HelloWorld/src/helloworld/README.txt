...
Things to note:
1. This file is created for beginners with a little background knowledge to coding, or are jumping from one programming language to Java
...
6. If you are a Windows 8 and below OR
7. If you are a Linux user, it may differ for you! Please do not assume that it will work the same! Try and test every line if needed!

Some MUST KNOW:
1. to comment use: "//"
2. to end a statement, use ";"
